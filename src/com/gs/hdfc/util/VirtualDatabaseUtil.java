...
public class VirtualDatabaseUtil {
	...
	static {
		...
		//String[] projects1 = { "SProject 1", "Sroject 2", "SProject 3" };
		Project[] projects1 = getProjectTable();
		...
		//String[] projects2 = { "SProject 11", "SProject 22", "Sroject 33" };

		// need to check long values
		Manager manager2 = new Manager(++manager_id, "Sample Manager 2", 26, 23576734.56, 'F', 4.5, projects1,
				new long[] { 234234, 2342455, 876786 });

		managerTable[1] = manager2;

		// need to check long values
		Manager manager3 = new Manager(++manager_id, "Sample Manager 3", 28, 23576734.56, 'M', 4.5, projects1,
				new long[] { 234234, 2342455, 876786 });

		managerTable[2] = manager3;
		
		// creating default project
		Project project4 = new Project(++project_id, "SProject name 1");
